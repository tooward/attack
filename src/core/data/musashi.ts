...
const LIGHT_PUNCH: MoveDefinition = {
  ...
  energyCost: 3,  // Small stamina cost
  superMeterGain: 10,
  superMeterCost: 0,
...
const HEAVY_PUNCH: MoveDefinition = {
  ...
  energyCost: 10,  // High stamina cost for powerful move
  superMeterGain: 20,
  superMeterCost: 0,
  cancellableInto: [],
...
const LIGHT_KICK: MoveDefinition = {
  ...
  energyCost: 4,  // Small-moderate stamina cost
  superMeterGain: 12,
  superMeterCost: 0,
...
const HEAVY_KICK: MoveDefinition = {
  ...
  energyCost: 5,  // Jumping attacks cost more stamina
  superMeterGain: 25,
  superMeterCost: 0,
  cancellableInto: [],
  cancellableOnHit: false,
...
const AIR_PUNCH: MoveDefinition = {
  ...
  energyCost: 8,  // Moderate stamina cost
  superMeterGain: 15,
  superMeterCost: 0,
  cancellableInto: [],
  cancellableOnHit: false,
...
const SUPER_COMBO: MoveDefinition = {
  ...
  energyCost: 3,  // Small stamina cost (crouching attack)
  superMeterGain: 0,
