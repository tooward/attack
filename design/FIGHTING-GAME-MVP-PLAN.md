...
### 7. **Production-Grade ML Training**

**Goal:** Train human-like bots with distinct personalities and difficulty levels.

**Architecture Principles:**
```
┌─────────────────────────────────────────────────────────────┐
│                    TRAINING PIPELINE                        │
│  - Dense reward shaping (tactical feedback, positioning)    │
│  - Opponent pool & Elo ranking (prevent collapse)          │
│  - Curriculum training (neutral → full game)               │
│  - Anti-degenerate detection (stalling, loops)             │
└─────────────────────────────────────────────────────────────┘
                              │
                              ▼
┌─────────────────────────────────────────────────────────────┐
│                    INFERENCE LAYER                          │
│  - Difficulty knobs (reaction delay, execution errors)      │
│  - Style conditioning (rushdown, zoner, turtle, mixup)      │
│  - Mobile-optimized (<5ms inference, <1MB models)          │
└─────────────────────────────────────────────────────────────┘
```

**Key Features:**
- **PPO Trainer:** Reinforcement learning with policy gradients
- **Opponent Pool:** 10-18 snapshots with Elo tracking
- **Curriculum Stages:** Neutral footsies → Punish → Defense → Combos → Full game
- **Difficulty Levels:** 10 levels with intentional weaknesses
- **Fighting Styles:** Rushdown, Zoner, Turtle, Mixup (distinct reward weights)
- **Evaluation Harness:** Win rate, Elo, diversity, stalling detection
- **Testability:** Full unit + integration test coverage
- **Mobile-Friendly:** Quantized models, <5ms inference, <1MB total size

**See [design/ML-TRAINING-SYSTEM-PLAN.md](design/ML-TRAINING-SYSTEM-PLAN.md) for complete details.**
...
### Phase 7: ML Training System (Week 8-12)

**Goal:** Implement production-grade reinforcement learning system for training human-like bots with distinct personalities and difficulty levels.

**Status:** 🔄 **PLANNED** - See [ML-TRAINING-SYSTEM-PLAN.md](design/ML-TRAINING-SYSTEM-PLAN.md) for full details

**Overview:**
Replace simple supervised learning with comprehensive RL training infrastructure including:
- **PPO trainer** with dense reward shaping
- **Opponent pool & league** system with Elo ranking
- **Curriculum training** for progressive skill development
- **Difficulty knobs** (Level 1-10 with reaction delay, execution errors)
- **Style conditioning** (rushdown, zoner, turtle, mixup)
- **Evaluation harness** with anti-degenerate detection
- **Mobile-optimized inference** (<5ms per decision)

**Key Improvements Over Current System:**
- ✅ Dense rewards (not just win/loss) - tactical feedback, positioning, anti-degenerate penalties
- ✅ Opponent diversity - league system prevents self-play collapse
- ✅ Progressive training - curriculum stages from neutral to full game
- ✅ Adjustable difficulty - 10 levels with intentional weaknesses
- ✅ Bot personality - 4+ distinct fighting styles
- ✅ Production ready - testable, mobile-friendly, <1MB models

**Implementation Phases:**
1. **Week 8:** Foundation (Environment, Observations, Rewards, PPO)
2. **Week 9:** Opponent Pool & Elo System
3. **Week 10:** Curriculum & Anti-Degenerate Measures
4. **Week 11:** Difficulty Knobs & Style Conditioning
5. **Week 12:** Evaluation Harness & Mobile Optimization

**Deliverables:**
- Bots that learn from experience (not just imitation)
- Level 1 loses to beginners, Level 10 beats intermediates
- 4 distinct playstyles (rushdown, zoner, turtle, mixup)
- <10% stalling time, >0.6 action diversity
- Models run at 60fps on mobile devices
- Comprehensive metrics and regression tests

**Success Metrics:**
- Bot beats scripted opponent >90%
- Level 10 reaches 2000+ Elo
- Players report bots feel "human-like"
- No exploitable patterns or cheese strategies
- All regression tests pass

---

### Phase 8: Second Character (Week 13)
...
### Phase 9: Third Character & Final Balance (Week 14-15)
...
### Revised Plan with ML Training System

| Phase | Plan | Focus | Status | Duration |
|-------|------|-------|--------|----------|
| 1 | Core Foundation | Headless game engine | ✅ COMPLETE | Week 1-2 |
| 2 | Phaser Integration | Rendering + UI | ✅ COMPLETE | Week 2-3 |
| 3 | AI Foundation | RandomBot, PersonalityBot, Replay | ✅ COMPLETE | Week 3-4 |
| 4 | TensorFlow.js Training | Neural nets, ImitationTrainer | ✅ COMPLETE | Week 4-5 |
| 5 | Special Moves & Combos | Motion inputs, projectiles, supers | 🔄 **IN PROGRESS** | Week 5-6 |
| 6 | Polish & Game Feel | Hit freeze, audio, training mode | NEXT | Week 6-7 |
| 7 | **ML Training System** | **Production RL infrastructure** | **PLANNED** | **Week 8-12** |
| 8 | Second Character | Ronin with distinct playstyle | PLANNED | Week 13 |
| 9 | Third Character & Balance | Ninja, final tuning | PLANNED | Week 14-15 |

### Phase 7 Breakdown: ML Training System (5 Weeks)

**See [design/ML-TRAINING-SYSTEM-PLAN.md](design/ML-TRAINING-SYSTEM-PLAN.md) for complete implementation details.**

| Week | Focus | Deliverables |
|------|-------|--------------|
| 8 | Foundation MVP | Environment, observations, rewards, PPO trainer |
| 9 | Opponent Pool | League system, Elo rankings, snapshot management |
| 10 | Curriculum & Safety | Progressive training, anti-degenerate detection |
| 11 | Difficulty & Styles | Level 1-10 knobs, style conditioning (4 styles) |
| 12 | Evaluation & Polish | Metrics harness, regression tests, mobile optimization |

**Key Improvements Over Original AI Plan:**
- ✅ **Reinforcement Learning:** Replace pure supervised learning with PPO + self-play
- ✅ **Dense Rewards:** Not just win/loss - tactical signals, positioning, anti-stalling
- ✅ **Opponent Diversity:** League system with Elo prevents collapse
- ✅ **Curriculum:** Progressive stages from basics to full game
- ✅ **Human-like Bots:** Difficulty knobs (reaction delay, errors) + style personalities
- ✅ **Production Ready:** <5ms inference, <1MB models, mobile-optimized
...
**Total MVP: ~15 weeks** (original 8 weeks + 5 weeks for production ML system + 2 weeks for additional characters)
...
7. 🎯 **PHASE 7 (Week 8-12):** Production RL Training System
   - See [design/ML-TRAINING-SYSTEM-PLAN.md](design/ML-TRAINING-SYSTEM-PLAN.md)
   - PPO trainer with dense reward shaping
   - Opponent pool & league with Elo ranking
   - Curriculum training (neutral → full game)
